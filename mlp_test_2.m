function [pred_matrix,Accuracy_percentage] = mlp_test_2(testdata,testclass,weightHidden1,weightHidden2,weightOutput)
    [m,n] = size(testdata);
    ...
    for i = 1:n
        for j = 1:m
            ...
            predclass = digit_classify_2(n_testdata,weightHidden1,weightHidden2,weightOutput);
